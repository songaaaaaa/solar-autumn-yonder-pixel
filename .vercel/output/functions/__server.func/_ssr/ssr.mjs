...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CIo9sFgY.mjs");
...
var manifest = { "4cf87c6908c84a654505edd7d2655f6e1618021079fbe6ae8347e0db2926b8f1": {
	functionName: "completeChat_createServerFn_handler",
	importer: () => import("./complete-chat-BiaI4oRi.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-D2EEBG30.mjs").then((n) => n.t),
